...
<div class="row">
    <div class="col-sm mt-3 mt-md-0 text-center">
        {% include figure.html path="assets/img/blogicra/icradebate.png" title="Debate" class="img-fluid rounded z-depth-1" width="60%" caption="The lineup of speakers for the ICRA 2025 Debate"%}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0 text-center">
        {% include figure.html path="assets/img/blogicra/withken.jpg" title="Ken and me" class="img-fluid rounded z-depth-1" width="40%" caption="Ken and me"%}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0 text-center">
        {% include figure.html path="assets/img/blogicra/keynote.png" title="Keynote" class="img-fluid rounded z-depth-1" width="60%" caption="Keynote speakers at the ICRA 2025 on manipulation"%}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0 text-center">
        {% include figure.html path="assets/img/blogicra/gatech.png" title="Georgia Tech" class="rounded z-depth-1" height="300px" caption="A snapshot from the Georgia Tech campus" %}
    </div>
    <div class="col-sm mt-3 mt-md-0 text-center">
        {% include figure.html path="assets/img/blogicra/coca.png" title="Coca-Cola Museum" class="rounded z-depth-1" height="300px" caption="Exploring the World of Coca-Cola in Atlanta" %}
    </div>
</div>